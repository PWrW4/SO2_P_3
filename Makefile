SO2_projekt3: SO2_projekt3.o Timer.o Status.o PersonType.o RoomType.o Visualization.o Person.o Room.o Classroom.o Cloakroom.o DeanOffice.o Floor.o Lecturer.o Student.o Checker.o DeanCrew.o Toilet.o Corridor.o Entrance.o
	g++ -std=c++11 -pthread -lncurses ./object/SO2_projekt3.o ./object/Timer.o ./object/RoomType.o ./object/Visualization.o ./object/Person.o ./object/Room.o ./object/Classroom.o ./object/Cloakroom.o ./object/DeanOffice.o ./object/Floor.o ./object/Lecturer.o ./object/Checker.o ./object/Student.o ./object/DeanCrew.o ./object/PersonType.o ./object/Status.o ./object/Toilet.o ./object/Corridor.o ./object/Entrance.o -o ./executable/SO2_projekt3
Toilet.o: Toilet.cpp
...
DeanCrew.o: DeanCrew.cpp
	g++ -std=c++11 -c DeanCrew.cpp -o ./object/DeanCrew.o
